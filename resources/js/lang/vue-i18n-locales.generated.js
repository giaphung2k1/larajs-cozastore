export default {
    ...
    'ja': {
        'auth': {
            'failed': '情報がレコードと一致しません',
            'throttle': 'ログイン試行の回数が多すぎます。<br>（{seconds}）秒後に再試行してください。',
            'throttle_minute': '5回以上ログイン失敗したため、{minute}分後に再度お試しください。',
            'login_fail': '不正なリクエストです。ユーザー名とパスワードを入力してください。',
            'credentials_incorrect': 'ログイン情報が間違っています。再度行ってください。',
            'server_error': 'サーバエラーが発生しています。',
            'not_access': 'アクセス権がありません',
            'login': {
                'email': 'メール',
                'password': 'パスワード',
                'login': 'ログイン',
                'remember': 'ログイン情報保持',
                'forgot_password': 'パスワードお忘れ?',
            },
            'error': {
                'email': 'メールが必須です。',
                'email_valid': 'メールが間違っています。',
                'password': 'パスワードが必須です。',
            },
            'forgot_password': 'パスワードお忘れ',
        ...
        'passwords': {
            'password': 'パスワードは英数字混在で、確認用パスワードと一致しなければなりません。',
            'reset': 'パスワードがリセットされました。',
            'sent': 'パスワードリセットのURLがメールに送信されました。',
            'token': 'パスワードリセットのトークンが間違っています。',
            'user': '指定のメールアドレスに当該するユーザーが見つかりません。',
        },
        'route': {
            'user': 'User',
            'user_create': 'Create User',
        ...
        'validation': {
            ...
            'password': {
                'lowercase': '{attribute}には少なくとも{number}小文字のアルファベット文字が含まれている必要があります',
                'uppercase': '{attribute}には少なくとも{number}大文字のアルファベット文字が含まれている必要があります',
                'number': '{attribute}には少なくとも{number}数字が含まれている必要があります',
                'symbols': '{attribute}には少なくとも{number}つの特殊文字が含まれている必要があります',
            },
            'custom': {
                'attribute-name': {
                    'rule-name': 'custom-message',
    ...
    'vi': {
        ...
        'button': {
            ...
            'update': 'Cập nhật',
            'confirm': 'Xác nhận',
            'add_product_detail': 'Thêm sản phẩm chi tiết',
        },
        'common': {
            'back_to_top': 'Back to top',
            'popup': {
