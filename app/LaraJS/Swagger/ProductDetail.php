 ...
 *              @OA\Schema (
 *                  required={"id", "price", "amount", "product_id", "size_id", "size_id"},
 *                  @OA\Property(property="price", type="VARCHAR", default="NONE", example="Miss Kariane Wolff", description=""),
     *                  @OA\Property(property="amount", type="INT", default="NONE", example="7504", description=""),
